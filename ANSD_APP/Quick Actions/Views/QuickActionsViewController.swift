...
class QuickActionsViewController: UITableViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let segueID = segue.identifier, chatSegueIDs.contains(segueID) {
            ...
            if let selectedItem = sender as? QuickActionsConversation {
    ...
    private func showActionDetails(for item: QuickActionsConversation) {
    ...
    private func showRenameAlert(for item: QuickActionsConversation, section: Int, row: Int) {
...
extension QuickActionsViewController: AddActionDelegate {
    ...
    func didCreateNewAction(_ action: QuickActionsConversation) {
