...
class FriendJoinViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    let fullConversation = ChatData2.fullConversation
    ...
    @IBAction func didTapStopButton(_ sender: UIButton) {
        ...
        let endAction = UIAlertAction(title: "End Session", style: .destructive) { _ in
            ...
            if let summaryNav = storyboard.instantiateViewController(withIdentifier: "SummaryNavController") as? UINavigationController,
               let summaryVC = summaryNav.topViewController as? FriendSummaryViewController {
