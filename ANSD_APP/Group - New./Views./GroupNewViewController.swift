...
class GroupNewViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if message.isIncoming {
            ...
            // 3. COLOR LOGIC: Apply unique color
            cell.nameLabel.textColor = getParticipantColor(displayName)
    ...
    func getParticipantColor(_ name: String) -> UIColor {
        let colors: [UIColor] = [
            .systemBlue, .systemOrange, .systemPurple, .systemGreen, .brown
        ]
            ...
            if let summaryNav = storyboard.instantiateViewController(withIdentifier: "SummaryNavController") as? UINavigationController,
               let summaryVC = summaryNav.topViewController as? GNSummaryViewController {
                ...
                summaryVC.participantsData = [
                    GNParticipantData(name: "Peter", summary: "Peter has gotten a look..."),
                    GNParticipantData(name: "Bruce", summary: "Bruce thinks that they are..."),
                    GNParticipantData(name: "Steve", summary: "Steve has dismissed it...")
                ]
