...
class QuickActionsTableViewCell: UITableViewCell {
    ...
    func configure(with item: QuickActionsConversation, isLast: Bool) {
...
class ConversationCardCell: UITableViewCell {
    ...
    func configure(with item: QuickActionsConversation) {
