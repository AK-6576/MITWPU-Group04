...
// Represents a single chat message with text, direction, and sender information
struct PCChatMessage: Sendable {
    let text: String
    let isIncoming: Bool
    let sender: String
}

// Container for pre-defined conversation data used throughout the app
struct PCChatData {
