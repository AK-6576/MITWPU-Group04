...
class FriendsSummaryViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, NotesCardCellDelegate2 {
    
    @IBOutlet weak var tableView: UITableView!
    @IBOutlet weak var optionsButton: UIBarButtonItem!
    
    // Data received from the Join Screen
    var conversationTitle = "Coffee Runs"
    var participantsData: [FriendParticipantData] = []
    var chatHistory: [ChatMessage2] = []
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        // Section 3 is the dynamic list of participants
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            let cell = tableView.dequeueReusableCell(withIdentifier: "SummarySectionHeaderCell1", for: indexPath) as! SummarySectionHeaderCell2
            cell.headerLabel.text = "Conversation Summary"
            cell.headerIcon.image = UIImage(systemName: "list.bullet.clipboard")
            return cell
        case 1:
            let cell = tableView.dequeueReusableCell(withIdentifier: "SummaryCardCell1", for: indexPath) as! SummaryCardCell2
        ...
        case 3:
            // Participant Rows
            let cell = tableView.dequeueReusableCell(withIdentifier: "ParticipantsCardCell1", for: indexPath) as! ParticipantCardCell2
        ...
        case 4:
            ...
            return cell
        case 5:
            let cell = tableView.dequeueReusableCell(withIdentifier: "NotesCardCell1", for: indexPath) as! NotesCardCell2
            cell.delegate = self
            return cell
        default:
    ...
    // Handles growing text view
    func didUpdateText(in cell: NotesCardCell2) {
