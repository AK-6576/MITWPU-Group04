...
class GroupNewViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    var messages: [GroupNewChat] = []
    let fullConversation = GroupNewChatData.fullConversation
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if message.sender == "System" {
            guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "SystemCell", for: indexPath) as? GroupNewCollectionViewCell else {
